 ...
 * @returns 
 */
const ImageViewer = ({ images, viewImages = 0, totalImages = 0, containerClass = '', imageClass = '', thumbClass = '', thumbImageClass = '', thumbMainClass = '' }) => {
  return (
    <ImageProvider images={images} viewImages={viewImages} totalImages={totalImages} containerClass={containerClass} imageClass ={imageClass} thumbClass={thumbClass} thumbImageClass = {thumbImageClass} thumbMainClass={thumbMainClass}>
      <ImageContainer/>
    </ImageProvider>
  )
}
